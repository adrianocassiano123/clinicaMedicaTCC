...
public class FormDeclaracao extends JFrame {
	...
	BeanDeclaracao beanDeclaracao = new BeanDeclaracao();
	DaoDeclaracao daodeclaracao = new DaoDeclaracao();
	Relatorio declaracao = new Relatorio();
	 ...
	 * Create the frame.
	 */
	public FormDeclaracao(String codigoAtendimento) {
		...
		editorPaneDescricao.setText("Declaro para os devidos fins que o (a) paciente acima descrito, esteve em "
				+ "consulta médica na data de hoje durante o período  "); 
		...
		JLabel lblAtestadoMdico = new JLabel("Declara\u00E7\u00E3o de Comparecimento");
		lblAtestadoMdico.setFont(new Font("Tahoma", Font.BOLD, 21));
		panel.add(lblAtestadoMdico);
		...
		gl_panel_2.setVerticalGroup(
			gl_panel_2.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_panel_2.createSequentialGroup()
					.addContainerGap()
					.addComponent(editorPaneDescricao, GroupLayout.DEFAULT_SIZE, 283, Short.MAX_VALUE)
					.addGap(22))
		);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				beanDeclaracao.setDescricao(editorPaneDescricao.getText());
				beanDeclaracao.setNomePaciente(textFieldNome.getText());
				beanDeclaracao.setNomeMedico(textFieldMedico.getText());
				
				daodeclaracao.finalizarDeclaracao(beanDeclaracao);
				
				
			 declaracao.SolicitarDeclaracao(Integer.parseInt(textFieldIdMarcacao.getText()));
				...
				.addGroup(gl_panel_1.createSequentialGroup()
					.addGroup(gl_panel_1.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel_1.createSequentialGroup()
							...
							.addGap(4)
							.addComponent(formattedTextFieldNascimento, GroupLayout.PREFERRED_SIZE, 237, GroupLayout.PREFERRED_SIZE))
			...
			gl_panel_1.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel_1.createSequentialGroup()
					...
					.addGroup(gl_panel_1.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(formattedTextFieldNascimento, GroupLayout.PREFERRED_SIZE, 33, GroupLayout.PREFERRED_SIZE))
