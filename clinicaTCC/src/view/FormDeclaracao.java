	...
	public FormDeclaracao(String codigoAtendimento) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				daodeclaracao.finalizarDeclaracao(beanDeclaracao, Integer.parseInt(textFieldIdMarcacao.getText()));

				int idDeclaracao = daodeclaracao.pegarIdDeclaracao(Integer.parseInt(textFieldIdMarcacao.getText()));

				System.out.println(idDeclaracao);

				declaracao.SolicitarDeclaracao(Integer.parseInt(textFieldIdMarcacao.getText()), idDeclaracao);
