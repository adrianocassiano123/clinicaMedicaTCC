...
import modelo.BeanAtestado;
import modelo.BeanMarcConsulta;
import modeloDao.DaoAtestado;
...
public class FormAtestado extends JFrame {
	...
	BeanAtestado beanAtestado= new BeanAtestado();
	Relatorio atestado = new Relatorio();
	 ...
	 * Create the frame.
	 */
	public FormAtestado(String codigoAtendimento) {
		...
		editorPaneDescricao.setText("Atesto para os devidos fins que o (a) paciente acima descrito, sob os meus cuidados, "
				+ "foi atendido e necessita de repouso durante "); 
		...
		JLabel lblAtestadoMdico = new JLabel("Atestado M\u00E9dico");
